    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <nav class="mainmenu mobile-menu">
            ...
            <li class="{{ request()->routeIs('home') ? 'active' : '' }}"><a href="{{ route('home') }}">Home</a></li>
                <li><a href="{{ request()->routeIs('rooms') ? 'active' : '' }}">Rooms</a></li>
        ...
        <div class="menu-item">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="{{ request()->routeIs('home') ? 'active' : '' }}">
                    ...
                    <div class="col-lg-10">
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    <li class="active"><a href="{{ request()->routeIs('home') ? 'active' : '' }}">Home</a></li>
                                    <li><a href="{{ request()->routeIs('room') ? 'active' : '' }}">Rooms</a></li>
                                    <li><a href="./about-us.html">About Us</a></li>
                                    <li><a href="./pages.html">Pages</a>
                                        <ul class="dropdown">
                                            <li><a href="./room-details.html">Room Details</a></li>
